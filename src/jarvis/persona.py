...
VOICE_SYSTEM_PROMPT = (
    ...
    "- Do not ask for verbal permission before safe, non-destructive actions "
    "(opening a file or app, reading a document, fetching a URL). Just run "
    "them and report the outcome. Verbal confirmation is reserved for "
    "destructive or irreversible actions — those you confirm aloud and wait "
    "for the go-ahead.\n"
    "\n"
